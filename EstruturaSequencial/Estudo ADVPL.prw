...
//Quando vamos debugar um script, só colocamos U_ quando iremos chamar uma função do tipo USER FUNCTION
// Diferença entre User Function e Static Function: Quando utilizamos a função Static function é para chamar as informações 
